...
namespace Actors.Enemies.EnemyAI
{
    public class EnemyRoamingState : EnemyState
    {
        ...
        public override void EnterState(global::Actors.Enemies.EnemyAI.EnemyAI enemyAI)
        {
            startPosition = enemyAI.StartingPosition;
            movementController = enemyAI.GetComponent<EnemyMovementController>();
        }

        public override void Update(global::Actors.Enemies.EnemyAI.EnemyAI enemyAI)
        {
        ...
        private void PerformRandomMovement(global::Actors.Enemies.EnemyAI.EnemyAI enemyAI)
        {
